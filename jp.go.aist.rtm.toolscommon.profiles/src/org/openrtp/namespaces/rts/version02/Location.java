...
public class Location {
    ...
    @XmlAttribute(name = "x", namespace = "http://www.openrtp.org/namespaces/rts_ext", required = true)
    protected BigInteger x;
    @XmlAttribute(name = "y", namespace = "http://www.openrtp.org/namespaces/rts_ext", required = true)
    protected BigInteger y;
    @XmlAttribute(name = "height", namespace = "http://www.openrtp.org/namespaces/rts_ext", required = true)
    protected BigInteger height;
    @XmlAttribute(name = "width", namespace = "http://www.openrtp.org/namespaces/rts_ext", required = true)
    protected BigInteger width;
    @XmlAttribute(name = "direction", namespace = "http://www.openrtp.org/namespaces/rts_ext", required = true)
