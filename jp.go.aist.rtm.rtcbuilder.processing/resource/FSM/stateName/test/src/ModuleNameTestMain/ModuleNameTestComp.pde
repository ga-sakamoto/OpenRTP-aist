...
/*!
 * @class ModuleNameTestComp
 * @brief Standalone component Class
 *
 */
public class ModuleNameTestComp implements ModuleInitProc {
    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(modulenametest_conf);
      mgr.registerFactory(prop, new ModuleNameTest(), new ModuleNameTest());
      // Create a component
      RTObject_impl comp = mgr.createComponent("ModuleNameTest");
      if( comp==null ) {
